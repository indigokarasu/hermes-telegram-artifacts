...
Historical note: previously, the `/artifact/<id>` GET route had to be manually added to `<fs-root>/.local/share/hermes-webui/webui/api/routes.py`. This is no longer required — the artifact server handles all serving independently.
